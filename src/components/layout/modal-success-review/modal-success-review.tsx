...
type SuccessReviewProps = {
  isVisible: boolean,
  onModalClose: () => void,
}

function ModalSuccessReview({isVisible, onModalClose}: SuccessReviewProps): JSX.Element {
        ...
        <div className="modal__wrapper">
          ...
          <div className="modal__content">
            ...
            <div className="modal__button-container modal__button-container--review">
              <button className="button button--small modal__button modal__button--review" onClick={handleModalClickClose}>К покупкам!</button>
            </div>
